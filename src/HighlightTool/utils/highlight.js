import $ from "jquery";
import onHighlightMouseEnterOrClick from "./onHighlightMouseEnterOrClick";
import onHighlightMouseLeave from "./onHighlightMouseLeave";

var HIGHLIGHT_CLASS =
  "notealy-highlighter-highlighted"; /* eslint-disable-line no-redeclare */
var DELETED_CLASS =
  "notealy-highlighter-deleted"; /* eslint-disable-line no-redeclare */
  ...
  container.contents().each((index, element) => {
    ...
    if (element.nodeType === Node.TEXT_NODE) {
      ...
      if (startFound && charsHighlighted < selectionLength) {
        ...
        if (firstSplitTextEl) {
          const highlightNode = document.createElement("notealy-highlight");
